...
import pytest
from source_bitbucket.source import BitbucketStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(BitbucketStream, "path", "v0/example_endpoint")
    mocker.patch.object(BitbucketStream, "primary_key", "test_primary_key")
    mocker.patch.object(BitbucketStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = BitbucketStream()
